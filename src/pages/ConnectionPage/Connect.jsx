...
function ConnectionPage() {
  ...
  const sampleData = [
    ...
    const [connectTerm, setConnectTerm] = React.useState('');
    ...
    const handleConnect = () => {
        console.log('Tìm kiếm với:', connectTerm, 'tại', location, 'trình độ', level, 'sắp xếp', sortOrder,  'và các options', selectedOptions);
        // TODO: Gọi API
    };
                ...
                <div className="connect-container">
                    ...
                    <div className="connect-bar">
                        <input
                            ...
                            value={connectTerm}
                            onChange={(e) => setConnectTerm(e.target.value)}
